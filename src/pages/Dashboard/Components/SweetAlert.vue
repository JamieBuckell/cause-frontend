<template>
  <div>
    ...
    <p class="category">
      ...
      friend
      <a target="_blank" rel="noopener" href="https://twitter.com/t4t5"
        >Tristan Edwards</a
    ...
    <p class="category">
      Highly customizable modal components. Please check out the
      <a
        href="http://element.eleme.io/#/en-US/component/dialog"
        target="_blank"
        rel="noopener"
        >full documentation.</a
      >
    ...
    <div class="row">
      <div class="col-md-3">
        <card>
          ...
          <el-dialog title="Basic Modal" :visible.sync="modals.basic">
            <span>This is a message</span>
            <span slot="footer" class="dialog-footer">
              <button class="btn btn-danger" @click="closeModal('basic')">
                Cancel</button
              >&nbsp;
              <button class="btn btn-success" @click="closeModal('basic')">
                Confirm
              </button>
            </span>
          </el-dialog>
      ...
      <div class="col-md-3">
        <card>
          ...
          >
            ...
            >
            <span slot="footer" class="dialog-footer">
              <button class="btn btn-danger" @click="closeModal('centered')">
                Cancel</button
              >&nbsp;
              <button class="btn btn-success" @click="closeModal('centered')">
                Confirm
              </button>
            </span>
          </el-dialog>
      ...
      <div class="col-md-3">
        <card>
          ...
          >
            ...
            >
            <span slot="footer" class="dialog-footer">
              <button class="btn btn-danger" @click="closeModal('confirm')">
                Cancel</button
              >&nbsp;
              <button class="btn btn-success" @click="closeModal('confirm')">
                Confirm
              </button>
            </span>
          </el-dialog>
